...
var TrovioSwitch = ({
  ...
  const switchElement = /* @__PURE__ */ jsx(
    Switch,
    {
      className: clsx16("group", !label ? className : void 0),
  ...
  return /* @__PURE__ */ jsxs("div", { className: clsx16("flex items-center gap-4", className), children: [
...
var TrovioSpinner = ({
  ...
  return /* @__PURE__ */ jsx(
    Spinner,
    {
      className: clsx16("text-trovio-primary", className),
      color: "current",
...
function WidgetCard({
  ...
  return /* @__PURE__ */ jsx(
    Card,
    {
      className: clsx16("w-full overflow-hidden", !noPadding && "p-6", className),
      style: { minHeight },
      ...props,
      children
    }
...
function RingGauge({
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      className: clsx16("relative inline-flex shrink-0", className),
      style: { width: size, height: size },
      children: [
...
function Sparkline({
  ...
  return /* @__PURE__ */ jsx(
    ...
    {
      "aria-hidden": "true",
      className: clsx16("shrink-0", className),
      height,
...
function SegmentedToggle({
  ...
  return /* @__PURE__ */ jsx("div", { className: clsx16("flex flex-wrap gap-2", className), role: "tablist", children: options.map((opt) => {
...
function GeneratingBlock({
  ...
  return /* @__PURE__ */ jsxs("div", { className: clsx16("space-y-4", className), children: [
  ...
  return /* @__PURE__ */ jsx("div", { className: "flex items-start", children: steps.map((step, idx) => {
    ...
    const node = step.status === "current" && onCurrentClick ? /* @__PURE__ */ jsx(
      "button",
      {
        ...
        className: clsx16(circle, "cursor-pointer"),
        type: "button",
