...
interface TrovioChipProps extends Omit<ChipProps, "color" | "variant"> {
    /**
     * Visual style:
...
declare const TrovioChip: react__default.FC<TrovioChipProps>;
