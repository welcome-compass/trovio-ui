...
var clsx35__default = /*#__PURE__*/_interopDefault(clsx35);
...
var TrovioButton = React2.forwardRef(
  (propsFromArgs, _ref) => {
    const {
      children,
      variant = "primary",
...
var FLATTEN_DUOTONE = "[&_path[opacity]]:opacity-0";
function TrovioIcon({
  icon: Icon,
  duotone = false,
  className,
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(Icon, { className: clsx35__default.default(!duotone && FLATTEN_DUOTONE, className), ...props });
}
...
var TrovioSwitch = ({
  ...
  const switchElement = /* @__PURE__ */ jsxRuntime.jsx(
    react.Switch,
    {
      className: clsx35__default.default("group", !label ? className : void 0),
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: clsx35__default.default("flex items-center gap-4", className), children: [
...
var TrovioSpinner = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    react.Spinner,
    {
      className: clsx35__default.default("text-trovio-primary", className),
      color: "current",
...
function WidgetCard({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    react.Card,
    {
      className: clsx35__default.default("w-full overflow-hidden", !noPadding && "p-6", className),
      style: { minHeight },
      ...props,
      children
    }
...
function RingGauge({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "div",
    {
      className: clsx35__default.default("relative inline-flex shrink-0", className),
      style: { width: size, height: size },
      children: [
...
function ScoreRing({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(RingGauge, { className, size, value: loading ? 0 : score / 100, children: /* @__PURE__ */ jsxRuntime.jsxs("span", { className: "flex flex-col items-center leading-none", children: [
    loading ? /* @__PURE__ */ jsxRuntime.jsx("span", { className: "h-4 w-5 animate-pulse rounded bg-trovio-light-text/10 dark:bg-trovio-dark-text/10" }) : /* @__PURE__ */ jsxRuntime.jsx("span", { className: "text-base font-bold text-trovio-light-text dark:text-trovio-dark-text", children: score }),
    /* @__PURE__ */ jsxRuntime.jsx("span", { className: "mt-0.5 text-[9px] font-medium text-trovio-light-text-muted dark:text-trovio-dark-text-muted", children: "/100" })
  ] }) });
}
function Sparkline({
  points,
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    ...
    {
      "aria-hidden": "true",
      className: clsx35__default.default("shrink-0", className),
      height,
...
function SegmentedToggle({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    "div",
    {
      className: clsx35__default.default("flex gap-2", fullWidth ? "w-full" : "flex-wrap", className),
      role: "tablist",
...
function TrovioSelect({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: clsx35__default.default("flex flex-col gap-1.5", className), children: [
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsx(react.Select.Popover, { children: /* @__PURE__ */ jsxRuntime.jsx(react.ListBox, { children: options.map((o) => /* @__PURE__ */ jsxRuntime.jsxs(
            react.ListBox.Item,
            {
              ...
              children: [
                o.label,
                /* @__PURE__ */ jsxRuntime.jsx(react.ListBox.ItemIndicator, {})
              ]
            },
            o.key
          )) }) })
    ...
    helperText ? /* @__PURE__ */ jsxRuntime.jsx("p", { className: "text-micro text-trovio-light-text-muted dark:text-trovio-dark-text-muted", children: helperText }) : null
  ] });
}
var DISPLAY_FORMAT = {
  year: "numeric",
...
function toCalendarDate(iso) {
  if (!iso) return null;
  try {
    return date.parseDate(iso);
  } catch {
    return null;
  }
}
function formatCalendarDate(date) {
  return new Intl.DateTimeFormat(void 0, DISPLAY_FORMAT).format(
    new Date(Date.UTC(date.year, date.month - 1, date.day))
  );
}
function TrovioDatePicker({
  value,
  onChange,
  minValue,
  label,
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsx(react.DatePicker.Popover, { triggerRef, children: /* @__PURE__ */ jsxRuntime.jsxs(react.Calendar, { minValue: earliest ?? void 0, children: [
            /* @__PURE__ */ jsxRuntime.jsxs(react.Calendar.Header, { children: [
              ...
              /* @__PURE__ */ jsxRuntime.jsx(react.Calendar.NavButton, { slot: "next" })
            ] }),
            /* @__PURE__ */ jsxRuntime.jsxs(react.Calendar.Grid, { children: [
              /* @__PURE__ */ jsxRuntime.jsx(react.Calendar.GridHeader, { children: (day) => /* @__PURE__ */ jsxRuntime.jsx(react.Calendar.HeaderCell, { children: day }) }),
              /* @__PURE__ */ jsxRuntime.jsx(react.Calendar.GridBody, { children: (date) => /* @__PURE__ */ jsxRuntime.jsx(react.Calendar.Cell, { date }) })
            ] })
          ] }) })
        ]
      }
...
var toBound = (n) => typeof n === "number" && Number.isFinite(n) ? n : null;
function resolveRange(rangeMin, rangeMax) {
...
function verdictFor(value, range) {
...
function RangeMeter({
  ...
  const pct = (n) => Math.max(0, Math.min(100, (n - domainLo) / (domainHi - domainLo) * 100));
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: clsx35__default.default("flex flex-col gap-1.5", className), children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsx(
      react.NumberField,
      {
        ...
        children: /* @__PURE__ */ jsxRuntime.jsxs(react.NumberField.Group, { children: [
          /* @__PURE__ */ jsxRuntime.jsx(react.NumberField.DecrementButton, {}),
          /* @__PURE__ */ jsxRuntime.jsx(react.NumberField.Input, {}),
          /* @__PURE__ */ jsxRuntime.jsx(react.NumberField.IncrementButton, {})
        ] })
      }
    ),
    range ? /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex flex-col gap-1.5 pt-1", children: [
      /* @__PURE__ */ jsxRuntime.jsx(RangeMeter, { range, value }),
      /* @__PURE__ */ jsxRuntime.jsxs("p", { className: "text-micro text-trovio-light-text-muted dark:text-trovio-dark-text-muted", children: [
        rangeLabel,
        " ",
        describeRange(range),
        verdict ? /* @__PURE__ */ jsxRuntime.jsxs("span", { className: clsx35__default.default("ml-1 font-medium", VERDICT_TONE[verdict]), children: [
          "\xB7 ",
...
function Timeline({ items, className }) {
  return /* @__PURE__ */ jsxRuntime.jsx(
    "ol",
    {
      ...
      children: items.map((it, i) => /* @__PURE__ */ jsxRuntime.jsxs("li", { className: "relative pb-3.5 last:pb-0", children: [
        /* @__PURE__ */ jsxRuntime.jsx(
          "span",
          {
        ...
        /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "text-caption font-medium text-trovio-light-text dark:text-trovio-dark-text", children: [
          it.title,
          it.note ? /* @__PURE__ */ jsxRuntime.jsx("span", { className: "ml-1.5 inline-flex rounded-full bg-trovio-primary/10 px-1.5 py-0.5 align-middle text-micro font-medium text-trovio-primary", children: it.note }) : null
        ] }),
        it.meta ? /* @__PURE__ */ jsxRuntime.jsx("div", { className: "text-micro text-trovio-light-text-muted dark:text-trovio-dark-text-muted", children: it.meta }) : null
      ] }, i))
    }
  );
}
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "div",
    {
      ...
      children: [
        ...
        badge ? /* @__PURE__ */ jsxRuntime.jsx("span", { className: "absolute right-2.5 top-2.5 rounded-full bg-white/90 px-2 py-0.5 text-[0.6875rem] font-bold text-trovio-light-text", children: badge }) : null,
        caption ? /* @__PURE__ */ jsxRuntime.jsx("span", { className: "absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/55 to-transparent px-3 py-2 text-caption font-semibold text-white", children: caption }) : null
      ]
    }
  );
}
function ClampText({
  ...
  const [overflows, setOverflows] = React2.useState(false);
  React2.useEffect(() => {
    const el = ref.current;
    if (!el) return;
    const check = () => {
...
function GeneratingBlock({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: clsx35__default.default("space-y-4", className), children: [
...
var OnboardingBrandHeader = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    "header",
    {
      ...
      children: /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "relative flex h-16 items-center justify-center px-4", children: [
        left ? /* @__PURE__ */ jsxRuntime.jsx("div", { className: "absolute left-4", children: left }) : null,
        logo,
        right ? /* @__PURE__ */ jsxRuntime.jsx("div", { className: "absolute right-4", children: right }) : null
      ] })
    }
  );
};
  ...
  function GoalCard2({ rank, icon, title, description, iconGradient, isDragging = false, className, ...rest }, ref) {
    return /* @__PURE__ */ jsxRuntime.jsxs(
      "div",
      {
        ...
        ...rest,
        children: [
          /* @__PURE__ */ jsxRuntime.jsx("div", { className: "absolute -left-2 -top-2 z-10 flex size-8 items-center justify-center rounded-full border-2 border-white bg-trovio-primary shadow-md dark:border-trovio-dark-bg", children: /* @__PURE__ */ jsxRuntime.jsx("span", { className: "select-none text-sm font-black text-white", children: rank }) }),
          /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-center gap-3 p-4", children: [
            /* @__PURE__ */ jsxRuntime.jsx("div", { className: "-my-4 -ml-4 flex flex-col gap-1 px-3 py-4 opacity-70", children: [...Array(6)].map((_, i) => /* @__PURE__ */ jsxRuntime.jsx(
              "div",
              {
            ...
            /* @__PURE__ */ jsxRuntime.jsx(
              "div",
              {
                ...
                children: /* @__PURE__ */ jsxRuntime.jsx("div", { className: "pointer-events-none text-2xl text-white", children: icon })
              }
            ),
            /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "min-w-0 flex-1 select-none", children: [
              /* @__PURE__ */ jsxRuntime.jsx("h3", { className: "text-base font-bold leading-tight text-trovio-light-text dark:text-trovio-dark-text", children: title }),
              /* @__PURE__ */ jsxRuntime.jsx("p", { className: "mt-0.5 text-xs leading-snug text-trovio-light-text-muted dark:text-trovio-dark-text-muted", children: description })
            ] })
          ] })
        ]
      }
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsx("blockquote", { className: "text-sm font-medium leading-relaxed text-trovio-light-text dark:text-trovio-dark-text", children: quote }),
        (attribution != null || source != null) && /* @__PURE__ */ jsxRuntime.jsxs(SectionLabel, { className: "mt-3", children: [
          attribution,
          attribution != null && source != null ? " \xB7 " : null,
          source
        ] }),
        hasCta ? /* @__PURE__ */ jsxRuntime.jsx("div", { className: "mt-3", children: ctaHref ? /* @__PURE__ */ jsxRuntime.jsx(
          "a",
          {
...
var Carousel = React2.forwardRef(function Carousel2({
  children,
  gap = 14,
  ...
  const [thumb, setThumb] = React2.useState({ width: 0, offset: 0 });
  ...
  const scrollByDir = React2.useCallback((dir) => {
    const rail = railRef.current;
    if (!rail) return;
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className, children: [
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "relative", children: [
      ...
      showArrows && showChrome && /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
        /* @__PURE__ */ jsxRuntime.jsx(
          "button",
          {
            "aria-label": "Scroll left",
            className: clsx35__default.default(arrowClass, "left-1"),
            disabled: !state.canLeft,
            type: "button",
            onClick: () => scrollByDir(-1),
            children: /* @__PURE__ */ jsxRuntime.jsx(pi.PiCaretLeftBold, { size: 14 })
          }
        ),
        /* @__PURE__ */ jsxRuntime.jsx(
          "button",
          {
            ...
            className: clsx35__default.default(arrowClass, "right-1"),
            disabled: !state.canRight,
            type: "button",
            onClick: () => scrollByDir(1),
            children: /* @__PURE__ */ jsxRuntime.jsx(pi.PiCaretRightBold, { size: 14 })
          }
        )
      ] }),
      /* @__PURE__ */ jsxRuntime.jsx(
        "div",
        {
          ...
          children: React2__default.default.Children.map(children, (child) => /* @__PURE__ */ jsxRuntime.jsx("div", { className: "shrink-0", style: { scrollSnapAlign: "start" }, children: child }))
        }
      )
    ] }),
    showProgress && showChrome && /* @__PURE__ */ jsxRuntime.jsx("div", { className: "mt-0.5 h-1 overflow-hidden rounded-full bg-trovio-light-border dark:bg-trovio-dark-border", children: /* @__PURE__ */ jsxRuntime.jsx(
      "div",
      {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "button",
    {
      ...
      children: [
        ...
        post.isVideo && /* @__PURE__ */ jsxRuntime.jsx("span", { className: "absolute inset-0 grid place-items-center text-white/90 [text-shadow:0_1px_4px_rgba(0,0,0,0.45)]", children: /* @__PURE__ */ jsxRuntime.jsx(pi.PiPlayFill, { size: 13 }) }),
        post.views != null && /* @__PURE__ */ jsxRuntime.jsx("span", { className: "absolute bottom-1 left-1.5 text-[10px] font-bold text-white [text-shadow:0_1px_2px_rgba(0,0,0,0.6)]", children: formatCompactNumber(post.views) })
      ]
    }
  );
}
function TopPostsStrip({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    "div",
    {
      className: clsx35__default.default("grid gap-2", className),
      style: { gridTemplateColumns: `repeat(${columns}, minmax(0, 1fr))` },
      children: posts.slice(0, columns).map((post, i) => /* @__PURE__ */ jsxRuntime.jsx(
        PostThumbnail,
        {
          post,
    ...
    "article",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-center gap-3", children: [
          ...
          showScore ? /* @__PURE__ */ jsxRuntime.jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntime.jsx(RingGauge, { color: fitArcColor(score), size: 40, stroke: 4, value: score / 100, children: /* @__PURE__ */ jsxRuntime.jsx("span", { className: "text-[13px] font-bold text-trovio-light-text dark:text-trovio-dark-text", children: score }) })
            }
          ) : null
        ] }),
        ...
        showActions && /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "mt-0.5 flex gap-2", children: [
          ...
          onStartCampaign && /* @__PURE__ */ jsxRuntime.jsx(
            TrovioButton,
            {
              className: "flex-1",
              size: "sm",
    ...
    "article",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-start gap-3", children: [
          /* @__PURE__ */ jsxRuntime.jsx("h3", { className: "min-w-0 flex-1 text-base font-semibold text-trovio-light-text dark:text-trovio-dark-text", children: name }),
          badge && /* @__PURE__ */ jsxRuntime.jsx(TrovioBadge, { className: "shrink-0", status: badge.status, children: badge.label })
        ] }),
        ...
        children,
        showActions && /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "mt-0.5 flex flex-wrap gap-2", children: [
          onEdit && /* @__PURE__ */ jsxRuntime.jsxs(
            TrovioButton,
            {
              ...
              onClick: onEdit,
              children: [
                /* @__PURE__ */ jsxRuntime.jsx(pi.PiPencilSimple, { size: 14 }),
                "Edit"
              ]
            }
          ),
          canTogglePause && /* @__PURE__ */ jsxRuntime.jsxs(
            TrovioButton,
            {
              className: "gap-1.5",
              isDisabled: isBusy,
              ...
              children: [
                paused ? /* @__PURE__ */ jsxRuntime.jsx(pi.PiPlay, { size: 14 }) : /* @__PURE__ */ jsxRuntime.jsx(pi.PiPause, { size: 14 }),
                paused ? "Resume" : "Pause"
              ]
            }
          ),
          onDelete && /* @__PURE__ */ jsxRuntime.jsxs(
            TrovioButton,
            {
              ...
              onClick: onDelete,
              children: [
                /* @__PURE__ */ jsxRuntime.jsx(pi.PiTrash, { size: 14 }),
                "Remove"
              ]
            }
          )
...
function CreatorCardSkeleton({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntime.jsx(TrovioSkeleton, { className: "h-11 w-11 rounded-full" }),
          /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex-1 space-y-2", children: [
            /* @__PURE__ */ jsxRuntime.jsx(TrovioSkeleton, { className: "h-3 w-1/2 rounded" }),
            /* @__PURE__ */ jsxRuntime.jsx(TrovioSkeleton, { className: "h-2.5 w-1/3 rounded" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntime.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntime.jsx(TrovioSkeleton, { className: "h-2.5 w-full rounded" }),
              /* @__PURE__ */ jsxRuntime.jsx(TrovioSkeleton, { className: "h-2.5 w-[88%] rounded" }),
              /* @__PURE__ */ jsxRuntime.jsx(TrovioSkeleton, { className: "h-2.5 w-3/5 rounded" })
            ]
          }
        ),
        showPosts && /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "grid grid-cols-3 gap-2", children: [
          /* @__PURE__ */ jsxRuntime.jsx(TrovioSkeleton, { className: "aspect-square rounded-lg" }),
          /* @__PURE__ */ jsxRuntime.jsx(TrovioSkeleton, { className: "aspect-square rounded-lg" }),
          /* @__PURE__ */ jsxRuntime.jsx(TrovioSkeleton, { className: "aspect-square rounded-lg" })
        ] }),
        showActions && /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "mt-0.5 flex gap-2", children: [
          /* @__PURE__ */ jsxRuntime.jsx(TrovioSkeleton, { className: "h-9 w-20 rounded-2xl" }),
          /* @__PURE__ */ jsxRuntime.jsx(TrovioSkeleton, { className: "h-9 flex-1 rounded-2xl" })
        ] })
      ]
    }
  );
}
var DefaultLink = ({ href, className, children }) => /* @__PURE__ */ jsxRuntime.jsx("a", { className, href, children });
function Breadcrumbs({ items, linkComponent, className }) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    "nav",
    {
      ...
      className: clsx35__default.default("flex items-center gap-1.5 text-caption", className),
      children: items.map((item, i) => {
        const isLast = i === items.length - 1;
        return /* @__PURE__ */ jsxRuntime.jsxs(React2.Fragment, { children: [
          i > 0 ? /* @__PURE__ */ jsxRuntime.jsx("span", { className: "text-trovio-light-text-muted/50 dark:text-trovio-dark-text-muted/50", children: "/" }) : null,
...
function BackButton({
  ...
  const cls = clsx35__default.default(
  ...
  const inner = /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    /* @__PURE__ */ jsxRuntime.jsx(pi.PiArrowLeftBold, { className: "h-3 w-3" }),
    label
  ] });
  if (href) {
    const Link = linkComponent ?? "a";
    return /* @__PURE__ */ jsxRuntime.jsx(Link, { className: cls, href, children: inner });
  }
  return /* @__PURE__ */ jsxRuntime.jsx("button", { className: cls, type: "button", onClick, children: inner });
}
...
function EmailMessage({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-start gap-3 border-b border-trovio-light-border px-4 py-3 dark:border-trovio-dark-border", children: [
          /* @__PURE__ */ jsxRuntime.jsx("div", { className: "flex h-9 w-9 shrink-0 items-center justify-center overflow-hidden rounded-full bg-trovio-primary/12 text-caption font-semibold text-trovio-primary", children: fromAvatarUrl ? (
            // eslint-disable-next-line @next/next/no-img-element
            /* @__PURE__ */ jsxRuntime.jsx("img", { alt: "", className: "h-full w-full object-cover", src: fromAvatarUrl })
          ) : initialOf(fromName) }),
          /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "min-w-0 flex-1", children: [
            tag ? /* @__PURE__ */ jsxRuntime.jsx("div", { className: "mb-0.5", children: tag }) : null,
            /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex flex-wrap items-baseline gap-x-1.5", children: [
              /* @__PURE__ */ jsxRuntime.jsx("span", { className: "text-caption font-semibold text-trovio-light-text dark:text-trovio-dark-text", children: fromName ?? "You" }),
              fromEmail ? /* @__PURE__ */ jsxRuntime.jsxs("span", { className: "text-micro text-trovio-light-text-muted dark:text-trovio-dark-text-muted", children: [
                "<",
                fromEmail,
                ">"
              ] }) : null
            ] }),
            to ? /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "text-micro text-trovio-light-text-muted dark:text-trovio-dark-text-muted", children: [
              "to ",
              to
            ] }) : null
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "px-4 py-3.5", children: [
          subject ? /* @__PURE__ */ jsxRuntime.jsx("p", { className: "mb-2 text-sm font-semibold text-trovio-light-text dark:text-trovio-dark-text", children: subject }) : null,
          /* @__PURE__ */ jsxRuntime.jsx("p", { className: "whitespace-pre-wrap text-sm leading-relaxed text-trovio-light-text/90 dark:text-trovio-dark-text/90", children: body })
        ] }),
        actions ? /* @__PURE__ */ jsxRuntime.jsx("div", { className: "flex flex-wrap items-center gap-2 border-t border-trovio-light-border px-4 py-2.5 dark:border-trovio-dark-border", children: actions }) : null
      ]
    }
  );
}
var DefaultLink2 = ({ href, className, children, ...rest }) => /* @__PURE__ */ jsxRuntime.jsx("a", { className, href, ...rest, children });
function BrandCard({
  brandName,
  description,
  logoUrl,
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-start gap-2.5", children: [
          /* @__PURE__ */ jsxRuntime.jsx("div", { className: "flex h-8 w-8 shrink-0 items-center justify-center overflow-hidden rounded-md bg-trovio-light-bg text-micro font-bold text-trovio-light-text-muted dark:bg-trovio-dark-bg dark:text-trovio-dark-text-muted", children: showLogo ? (
            // eslint-disable-next-line @next/next/no-img-element
            /* @__PURE__ */ jsxRuntime.jsx(
              "img",
              {
          ...
          /* @__PURE__ */ jsxRuntime.jsx("span", { className: "min-w-0 flex-1 truncate pt-1 text-sm font-semibold text-trovio-light-text dark:text-trovio-dark-text", children: brandName }),
          onDismiss ? /* @__PURE__ */ jsxRuntime.jsx(
            "button",
            {
              ...
              type: "button",
              onClick: onDismiss,
              children: /* @__PURE__ */ jsxRuntime.jsx(pi.PiXBold, { className: "h-3 w-3" })
            }
          ) : null
        ] }),
        description ? /* @__PURE__ */ jsxRuntime.jsx(
...
function HeadlineBlock({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className, children: [
    ...
    cta ? /* @__PURE__ */ jsxRuntime.jsx("div", { className: "mt-4", children: /* @__PURE__ */ jsxRuntime.jsx(TrovioButton, { size: "md", variant: "primary", onPress: cta.onClick, children: /* @__PURE__ */ jsxRuntime.jsxs("span", { className: "inline-flex items-center gap-2", children: [
      cta.icon,
      cta.label
    ] }) }) }) : null
  ] });
...
function TitledPanel({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("section", { className: clsx35__default.default("flex flex-col gap-4", className), children: [
    title != null ? /* @__PURE__ */ jsxRuntime.jsx(HeadlineBlock, { size: titleSize, weight: titleWeight, children: title }) : null,
    ...
    "a",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "px-4 py-3", children: [
          eyebrow != null ? /* @__PURE__ */ jsxRuntime.jsx(SectionLabel, { children: eyebrow }) : null,
          /* @__PURE__ */ jsxRuntime.jsx("div", { className: "mt-0.5 font-semibold text-trovio-light-text dark:text-trovio-dark-text", children: title })
        ] })
      ]
    }
  );
...
function JourneyStepper({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex flex-col", children: [
    /* @__PURE__ */ jsxRuntime.jsx("div", { className: "flex items-start", children: steps.map((step, idx) => {
      const isFirst = idx === 0;
      ...
      const circle = clsx35__default.default(
        circleBase,
      ...
      const node = step.status === "current" && onCurrentClick ? /* @__PURE__ */ jsxRuntime.jsx(
        "button",
        {
          ...
          className: clsx35__default.default(circle, "cursor-pointer"),
          type: "button",
    ...
    note ? /* @__PURE__ */ jsxRuntime.jsx("div", { className: "mt-4 flex justify-center", children: /* @__PURE__ */ jsxRuntime.jsxs("span", { className: "inline-flex items-center gap-1.5 rounded-full bg-trovio-primary/10 px-3 py-1 text-caption font-medium text-trovio-primary dark:bg-trovio-primary/15", children: [
      /* @__PURE__ */ jsxRuntime.jsx(
        "svg",
        {
          "aria-hidden": "true",
          ...
          fill: "currentColor",
          viewBox: "0 0 24 24",
          children: /* @__PURE__ */ jsxRuntime.jsx("path", { d: "M12 2l2 8 8 2-8 2-2 8-2-8-8-2 8-2z" })
        }
      ),
      note
    ] }) }) : null
  ...
  const metrics = [
    {
      ...
      Icon: pi.PiUsersThreeDuotone
    },
    {
      label: "Eng. rate",
      value: engagementRate != null ? `${(engagementRate * 100).toFixed(1)}%` : "5.2%",
      Icon: pi.PiTrendUpDuotone
    },
    {
      label: "Avg. views",
      value: avgViews != null ? formatCompactNumber(avgViews) : "8.4K",
      Icon: pi.PiEyeDuotone
    }
  ];
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "overflow-hidden rounded-lg border border-trovio-light-border bg-trovio-light-bg dark:border-trovio-dark-border dark:bg-trovio-dark-bg", children: [
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "relative overflow-hidden bg-gradient-to-br from-trovio-primary/[0.07] to-trovio-primary/[0.03] px-4 py-4", children: [
      /* @__PURE__ */ jsxRuntime.jsx(
        "div",
        {
          "aria-hidden": "true",
      ...
      /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "relative flex items-center gap-3.5", children: [
        /* @__PURE__ */ jsxRuntime.jsx(Avatar, { imageUrl: portraitUrl, name: name ?? "", size: 56 }),
        /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "min-w-0 flex-1", children: [
          /* @__PURE__ */ jsxRuntime.jsx(SectionLabel, { tone: "primary", children: "Media Kit" }),
          name ? /* @__PURE__ */ jsxRuntime.jsx("p", { className: "truncate text-lg font-bold leading-tight text-trovio-light-text dark:text-trovio-dark-text", children: name }) : null,
          platforms && platforms.length > 0 && /* @__PURE__ */ jsxRuntime.jsx("span", { className: "mt-1 flex items-center gap-1.5 text-trovio-light-text-muted dark:text-trovio-dark-text-muted", children: platforms.map((p) => /* @__PURE__ */ jsxRuntime.jsx(PlatformIcon, { platform: p, size: 14 }, p)) })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntime.jsx("div", { className: "grid grid-cols-3 divide-x divide-trovio-light-border dark:divide-trovio-dark-border", children: metrics.map((m) => /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-center gap-2 px-3 py-3", children: [
      /* @__PURE__ */ jsxRuntime.jsx("span", { className: "flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-trovio-primary/10 text-trovio-primary", children: /* @__PURE__ */ jsxRuntime.jsx(m.Icon, { size: 17 }) }),
      /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "min-w-0", children: [
        /* @__PURE__ */ jsxRuntime.jsx("p", { className: "truncate text-sm font-bold leading-tight text-trovio-light-text dark:text-trovio-dark-text", children: m.value }),
        /* @__PURE__ */ jsxRuntime.jsx("p", { className: `truncate ${META_TEXT}`, children: m.label })
      ] })
    ] }, m.label)) })
  ] });
}
var BRAND_MATCHER_ROWS = [
  {
    Tile: pi.PiStarDuotone,
    Badge: pi.PiTrendUpDuotone,
  ...
  {
    Tile: pi.PiUsersThreeDuotone,
    Badge: pi.PiHeartDuotone,
  ...
  {
    Tile: pi.PiLightningDuotone,
    Badge: pi.PiClockDuotone,
...
function BrandMatcherPreview() {
  return /* @__PURE__ */ jsxRuntime.jsx("div", { className: "divide-y divide-trovio-light-border overflow-hidden rounded-lg border border-trovio-light-border bg-trovio-light-bg dark:divide-trovio-dark-border dark:border-trovio-dark-border dark:bg-trovio-dark-bg", children: BRAND_MATCHER_ROWS.map((row) => /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-center gap-3 p-3", children: [
    /* @__PURE__ */ jsxRuntime.jsx("span", { className: "flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-trovio-primary/10 text-trovio-primary", children: /* @__PURE__ */ jsxRuntime.jsx(row.Tile, { size: 22 }) }),
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "min-w-0 flex-1", children: [
      /* @__PURE__ */ jsxRuntime.jsx("p", { className: "text-sm font-semibold text-trovio-light-text dark:text-trovio-dark-text", children: row.title }),
      /* @__PURE__ */ jsxRuntime.jsx("p", { className: "mt-0.5 text-xs leading-snug text-trovio-light-text-muted dark:text-trovio-dark-text-muted", children: row.description })
    ] }),
    /* @__PURE__ */ jsxRuntime.jsxs("span", { className: "flex shrink-0 items-center gap-1.5 rounded-lg bg-trovio-primary/10 px-2.5 py-1 text-trovio-primary", children: [
      /* @__PURE__ */ jsxRuntime.jsx(row.Badge, { className: "shrink-0", size: 13 }),
      /* @__PURE__ */ jsxRuntime.jsx("span", { className: "whitespace-nowrap text-xs font-medium", children: row.badgeLabel })
    ] })
  ] }, row.title)) });
}
...
var POST_ANALYZER_METRICS = [
  {
    Icon: pi.PiMagnetDuotone,
    title: "Hook",
    subtitle: "Grab attention early.",
    pct: 86
  },
  {
    Icon: pi.PiWaveSineDuotone,
    title: "Pacing",
    subtitle: "Keep momentum going.",
    pct: 72
  },
  {
    Icon: pi.PiTargetDuotone,
    title: "Pillar fit",
...
function PostAnalyzerPreview({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: PREVIEW_SHELL, children: [
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-center gap-3.5", children: [
      /* @__PURE__ */ jsxRuntime.jsx("div", { className: "relative aspect-[4/5] w-16 shrink-0 overflow-hidden rounded-lg", children: thumbnailUrl ? (
        // eslint-disable-next-line @next/next/no-img-element
        /* @__PURE__ */ jsxRuntime.jsx(
          "img",
          {
      ...
      /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "min-w-0 flex-1", children: [
        /* @__PURE__ */ jsxRuntime.jsx("span", { className: "inline-flex rounded-md bg-trovio-primary/10 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wide text-trovio-primary", children: "Overall score" }),
        /* @__PURE__ */ jsxRuntime.jsx("p", { className: "mt-1.5 text-sm font-bold leading-snug text-trovio-light-text dark:text-trovio-dark-text", children: "Strong hook \u2014 tighten the middle." }),
        /* @__PURE__ */ jsxRuntime.jsx("p", { className: `mt-1 leading-snug ${META_TEXT}`, children: "Great start \u2014 your post is well-structured. A few tweaks will make it even stronger." })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntime.jsx("div", { className: "mt-4 space-y-1 border-t border-trovio-light-border pt-3 dark:border-trovio-dark-border", children: POST_ANALYZER_METRICS.map((m) => /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-center gap-3 py-1.5", children: [
      /* @__PURE__ */ jsxRuntime.jsx("span", { className: "flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-trovio-primary/10 text-trovio-primary", children: /* @__PURE__ */ jsxRuntime.jsx(m.Icon, { size: 18 }) }),
      /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "w-24 shrink-0", children: [
        /* @__PURE__ */ jsxRuntime.jsx("p", { className: "text-sm font-semibold leading-tight text-trovio-light-text dark:text-trovio-dark-text", children: m.title }),
        /* @__PURE__ */ jsxRuntime.jsx("p", { className: `line-clamp-2 leading-snug ${META_TEXT}`, children: m.subtitle })
      ] }),
      /* @__PURE__ */ jsxRuntime.jsx("div", { className: "relative flex-1", children: /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "relative h-1.5 w-full rounded-full bg-trovio-light-border dark:bg-trovio-dark-border", children: [
        /* @__PURE__ */ jsxRuntime.jsx(
          "div",
          {
      ...
      /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "w-9 shrink-0 text-right", children: [
        /* @__PURE__ */ jsxRuntime.jsx("p", { className: "text-sm font-bold leading-none text-trovio-light-text dark:text-trovio-dark-text", children: m.pct }),
        /* @__PURE__ */ jsxRuntime.jsx("p", { className: `mt-0.5 ${META_TEXT}`, children: "/100" })
      ] })
    ] }, m.title)) })
  ] });
}
...
function CourseCallout({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "div",
    {
      ...
      children: [
        media ? /* @__PURE__ */ jsxRuntime.jsx("div", { className: "w-full", children: media }) : imageUrl ? (
        ...
        /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "p-4", children: [
          /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-center gap-2", children: [
            eyebrow != null ? /* @__PURE__ */ jsxRuntime.jsx(SectionLabel, { tone: "primary", children: eyebrow }) : null,
          ...
          /* @__PURE__ */ jsxRuntime.jsx("h3", { className: "mt-1 text-lg font-bold leading-tight text-trovio-light-text dark:text-trovio-dark-text", children: title }),
          description != null ? /* @__PURE__ */ jsxRuntime.jsx("p", { className: "mt-1.5 text-sm leading-relaxed text-trovio-light-text-muted dark:text-trovio-dark-text-muted", children: description }) : null,
          hasPrice ? /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "mt-3 flex items-center gap-2", children: [
            priceLabel != null ? /* @__PURE__ */ jsxRuntime.jsx("span", { className: "text-xl font-bold text-trovio-light-text dark:text-trovio-dark-text", children: priceLabel }) : null,
            ...
            discountLabel != null ? /* @__PURE__ */ jsxRuntime.jsx("span", { className: "rounded-md bg-trovio-primary/10 px-2 py-0.5 text-xs font-semibold text-trovio-primary", children: discountLabel }) : null
          ] }) : null,
          /* @__PURE__ */ jsxRuntime.jsx(
            TrovioButton,
            {
...
exports.MediaKitPreview = MediaKitPreview;
exports.OfferField = OfferField;
exports.OnboardingBrandHeader = OnboardingBrandHeader;
...
exports.TopPostsStrip = TopPostsStrip;
...
exports.TrovioSelect = TrovioSelect;
